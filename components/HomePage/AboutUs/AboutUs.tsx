      ...
      <div className="relative overflow-hidden">
        <section className="relative w-full px-4 py-12 md:py-16">
          ...
          <div className="relative mx-auto max-w-7xl">
            ...
            {/* Single shared grid — each pair is one row so heights sync automatically */}
            <div className="relative z-10 grid grid-cols-2 gap-x-10 gap-y-2 py-6 md:py-8">
              {/* Headers */}
              ...
              {/* Pairs — problem and solution share the same grid row */}
              {pairs.map((pair, idx) => (
                <React.Fragment key={idx}>
                  <div className="mx-4 group flex items-center rounded-2xl border-2 border-red-100 bg-white/80 p-3 shadow-sm backdrop-blur-sm transition-all duration-300 hover:border-red-200 hover:shadow-xl">
